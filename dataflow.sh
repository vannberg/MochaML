...
#Recommend chmod +x dataflow.sh, ./dataflow.sh <search term 1> <optional search term 2>, etc i.e. ./dataflow.sh metagenomics git
mkdir MochaML
cd MochaML
curl -o ./googler https://raw.githubusercontent.com/jarun/googler/v3.7.1/googler
python3 googler --np -n 100 -C $1 $2 $3 $4 > out.txt
